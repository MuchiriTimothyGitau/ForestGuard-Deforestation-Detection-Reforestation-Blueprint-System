...
**Endpoint:** `GET https://app-bs8umh6bsikh-api-oLpZ7eD5jJ5a.gateway.appmedo.com/v1/news/sources`
...
async function getSources(params: SourcesParams = {}): Promise<SourcesResponse> {
  ...
  const response = await fetch(
    `https://app-bs8umh6bsikh-api-oLpZ7eD5jJ5a.gateway.appmedo.com/v1/news/sources${qs ? `?${qs}` : ""}`,
    {
      method: "GET",
      headers: {
