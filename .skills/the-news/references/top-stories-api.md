...
**Endpoint:** `GET https://app-bs8umh6bsikh-api-wL1zlEdVM6DY.gateway.appmedo.com/v1/news/top`
...
async function getTopStories(params: TopStoriesParams = {}): Promise<TopStoriesResponse> {
  ...
  const response = await fetch(
    `https://app-bs8umh6bsikh-api-wL1zlEdVM6DY.gateway.appmedo.com/v1/news/top${qs ? `?${qs}` : ""}`,
    {
      method: "GET",
      headers: {
