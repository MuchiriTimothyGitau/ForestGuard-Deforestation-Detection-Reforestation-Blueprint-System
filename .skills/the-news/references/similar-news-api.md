...
**Endpoint:** `GET https://app-bs8umh6bsikh-api-m9xKXDbR1oka.gateway.appmedo.com/v1/news/similar/{uuid}`
...
async function getSimilarNews(uuid: string, params: SimilarNewsParams = {}): Promise<SimilarNewsResponse> {
  ...
  const response = await fetch(
    `https://app-bs8umh6bsikh-api-m9xKXDbR1oka.gateway.appmedo.com/v1/news/similar/${encodeURIComponent(uuid)}${qs ? `?${qs}` : ""}`,
    {
      method: "GET",
      headers: {
