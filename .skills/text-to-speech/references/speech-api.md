...
| Property | Value |
|----------|-------|
| Endpoint | `POST https://app-bs8umh6bsikh-api-GYX1lzGw01Xa.gateway.appmedo.com/v1/audio/speech` |
| HTTP Method | `POST` |
...
async function textToSpeech(
  ...
  const response = await fetch("https://app-bs8umh6bsikh-api-GYX1lzGw01Xa.gateway.appmedo.com/v1/audio/speech", {
    method: "POST",
    headers: {
...
```bash
curl -s -X POST "https://app-bs8umh6bsikh-api-GYX1lzGw01Xa.gateway.appmedo.com/v1/audio/speech" \
...
serve(async (req: Request): Promise<Response> => {
  ...
  // --- Call upstream ---
  const upstream = await fetch("https://app-bs8umh6bsikh-api-GYX1lzGw01Xa.gateway.appmedo.com/v1/audio/speech", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
      "X-Gateway-Authorization": `Bearer ${apiKey}`,
