...
| Property | Value |
|----------|-------|
| Endpoint | `POST https://app-bs8umh6bsikh-api-W9z3M6eONl3L.gateway.appmedo.com/parse/image` |
...
async function ocrParseImage(params: {
  ...
  const response = await fetch("https://app-bs8umh6bsikh-api-W9z3M6eONl3L.gateway.appmedo.com/parse/image", {
    method: "POST",
    headers: {
...
serve(async (req: Request): Promise<Response> => {
  ...
  // --- Call upstream ---
  const upstream = await fetch("https://app-bs8umh6bsikh-api-W9z3M6eONl3L.gateway.appmedo.com/parse/image", {
    method: "POST",
    headers: {
