...
| Item | Details |
|------|---------|
| Endpoint | `POST https://app-bs8umh6bsikh-api-rY7JZvg0dqdL.gateway.appmedo.com/v1/videos/image2video` |
...
async function submitImageToVideo(params: {
  ...
  const response = await fetch(
    "https://app-bs8umh6bsikh-api-rY7JZvg0dqdL.gateway.appmedo.com/v1/videos/image2video",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
