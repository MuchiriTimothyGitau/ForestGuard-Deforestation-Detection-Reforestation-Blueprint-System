...
| Property | Value |
|----------|-------|
| **Endpoint** | `POST https://app-bs8umh6bsikh-api-eLMlJj3KJD89.gateway.appmedo.com/v1/videos/image2video` |
...
async function submitImage2VideoTask(params: {
  ...
  const response = await fetch(
    "https://app-bs8umh6bsikh-api-eLMlJj3KJD89.gateway.appmedo.com/v1/videos/image2video",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
