...
- **Endpoint**: `GET https://app-bs8umh6bsikh-api-VaOwP8E7dKEa.gateway.appmedo.com/search/FgEFxazBTfRUumJx/smart`
...
async function callWebSearch(
  ...
  const response = await fetch(
    `https://app-bs8umh6bsikh-api-VaOwP8E7dKEa.gateway.appmedo.com/search/FgEFxazBTfRUumJx/smart?${params.toString()}`,
    {
      method: "GET",
      headers: {
