...
| Property | Value |
|----------|-------|
| Endpoint | `POST https://app-bs8umh6bsikh-api-k93RvqRrRZba.gateway.appmedo.com/v1/videos/omni-video` |
| HTTP Method | `POST` |
...
async function submitOmniVideo(options: OmniVideoSubmitOptions): Promise<{ taskId: string }> {
  const response = await fetch(
    "https://app-bs8umh6bsikh-api-k93RvqRrRZba.gateway.appmedo.com/v1/videos/omni-video",
    {
      method: "POST",
      headers: {
