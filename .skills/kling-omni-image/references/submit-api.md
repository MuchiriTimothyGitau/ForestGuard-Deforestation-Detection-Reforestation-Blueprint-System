...
**Endpoint:** `POST https://app-bs8umh6bsikh-api-2Y00Vzbe0MBY.gateway.appmedo.com/v1/images/omni-image`
...
async function submitOmniImageTask(params: SubmitParams): Promise<SubmitResult> {
  ...
  const response = await fetch(
    "https://app-bs8umh6bsikh-api-2Y00Vzbe0MBY.gateway.appmedo.com/v1/images/omni-image",
    {
      method: "POST",
      headers: {
