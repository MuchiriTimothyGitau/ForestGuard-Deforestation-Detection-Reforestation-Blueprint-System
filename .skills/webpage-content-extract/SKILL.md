...
- **Endpoint**: `GET/POST https://app-bs8umh6bsikh-api-Q9KWZ8R7Qv09.gateway.appmedo.com/v3/article`
...
async function callWebpageContentExtract(
  ...
  const response = await fetch(
    `https://app-bs8umh6bsikh-api-Q9KWZ8R7Qv09.gateway.appmedo.com/v3/article?${params.toString()}`,
    {
