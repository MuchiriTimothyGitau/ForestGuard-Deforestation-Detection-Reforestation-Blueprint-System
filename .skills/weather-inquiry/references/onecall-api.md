...
**Endpoint**: `GET https://app-bs8umh6bsikh-api-wL1zlmgJGAlY.gateway.appmedo.com/data/3.0/onecall`
...
**Endpoint**: `GET https://app-bs8umh6bsikh-api-Aa2PZmgJq5OL.gateway.appmedo.com/data/3.0/onecall/timemachine`
...
**Endpoint**: `GET https://app-bs8umh6bsikh-api-2Y00zmgJ8lBY.gateway.appmedo.com/data/3.0/onecall/day_summary`
...
**Endpoint**: `GET https://app-bs8umh6bsikh-api-oYA6ZxVqenDa.gateway.appmedo.com/data/3.0/onecall/overview`
...
async function getCurrentAndForecast(
  ...
  const response = await fetch(
    `https://app-bs8umh6bsikh-api-wL1zlmgJGAlY.gateway.appmedo.com/data/3.0/onecall?${params}`,
    {
      method: "GET",
      headers: {
...
async function getWeatherByTimestamp(
  ...
  const response = await fetch(
    `https://app-bs8umh6bsikh-api-Aa2PZmgJq5OL.gateway.appmedo.com/data/3.0/onecall/timemachine?${params}`,
    {
      method: "GET",
      headers: {
        "Accept": "application/json",
...
async function getDailyAggregation(
  ...
  const response = await fetch(
    `https://app-bs8umh6bsikh-api-2Y00zmgJ8lBY.gateway.appmedo.com/data/3.0/onecall/day_summary?${params}`,
    {
      method: "GET",
      headers: {
        "Accept": "application/json",
...
async function getWeatherOverview(
  ...
  const response = await fetch(
    `https://app-bs8umh6bsikh-api-oYA6ZxVqenDa.gateway.appmedo.com/data/3.0/onecall/overview?${params}`,
    {
      method: "GET",
      headers: {
        "Accept": "application/json",
...
|----------|-------------------|---------------------|--------------|
| Historical weather for a timestamp | `weather-timemachine.ts` | `lat`, `lon`, `dt` | `https://app-bs8umh6bsikh-api-Aa2PZmgJq5OL.gateway.appmedo.com/data/3.0/onecall/timemachine` |
| Daily aggregated statistics | `weather-day-summary.ts` | `lat`, `lon`, `date` | `https://app-bs8umh6bsikh-api-2Y00zmgJ8lBY.gateway.appmedo.com/data/3.0/onecall/day_summary` |
| AI weather overview | `weather-overview.ts` | `lat`, `lon` | `https://app-bs8umh6bsikh-api-oYA6ZxVqenDa.gateway.appmedo.com/data/3.0/onecall/overview` |
