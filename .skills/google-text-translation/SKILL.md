...
| Item | Details |
|------|---------|
| Endpoint | `POST https://app-bs8umh6bsikh-api-GaDwZ8DX7jPY.gateway.appmedo.com/language/translate/v2` |
...
async function translateText(params: TranslateParams): Promise<TranslationResult[]> {
  const response = await fetch(
    "https://app-bs8umh6bsikh-api-GaDwZ8DX7jPY.gateway.appmedo.com/language/translate/v2",
    {
      method: "POST",
      headers: {
