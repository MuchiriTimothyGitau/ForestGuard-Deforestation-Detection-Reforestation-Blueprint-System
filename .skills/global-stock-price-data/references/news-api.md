...
**Endpoint:** `GET https://app-bs8umh6bsikh-api-AalZze1qEWML.gateway.appmedo.com/v1/news/all`
...
async function getFinanceNews(params: NewsParams = {}): Promise<NewsResponse> {
  ...
  const response = await fetch(
    `https://app-bs8umh6bsikh-api-AalZze1qEWML.gateway.appmedo.com/v1/news/all?${query.toString()}`,
