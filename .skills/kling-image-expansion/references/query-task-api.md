...
| Item | Details |
|------|---------|
| Endpoint | `GET https://app-bs8umh6bsikh-api-AalZkkAG5w7L.gateway.appmedo.com/v1/images/editing/expand/{task_id}` |
...
| Item | Details |
|------|---------|
| Endpoint | `GET https://app-bs8umh6bsikh-api-pLVzAAkGZwDL.gateway.appmedo.com/v1/images/editing/expand` |
...
async function listExpandTasks(pageNum = 1, pageSize = 30): Promise<Array<{
  ...
  const url = new URL(
    "https://app-bs8umh6bsikh-api-pLVzAAkGZwDL.gateway.appmedo.com/v1/images/editing/expand"
  );
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    `https://app-bs8umh6bsikh-api-AalZkkAG5w7L.gateway.appmedo.com/v1/images/editing/expand/${task_id}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
