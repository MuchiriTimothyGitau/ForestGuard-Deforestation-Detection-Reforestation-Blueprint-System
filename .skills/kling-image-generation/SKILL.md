...
| Item | Details |
|------|---------|
| Create Task Endpoint | `POST https://app-bs8umh6bsikh-api-DY8MnRlwkXKa.gateway.appmedo.com/v1/images/generations` |
| Query Task Endpoint | `GET https://app-bs8umh6bsikh-api-M9v0wzOkZXGY.gateway.appmedo.com/v1/images/generations/{task_id}` |
...
async function createImageTask(params: {
  ...
  const response = await fetch(
    "https://app-bs8umh6bsikh-api-DY8MnRlwkXKa.gateway.appmedo.com/v1/images/generations",
    {
      method: "POST",
      headers: {
...
async function queryImageTask(taskId: string): Promise<{
  ...
  const response = await fetch(
    `https://app-bs8umh6bsikh-api-M9v0wzOkZXGY.gateway.appmedo.com/v1/images/generations/${taskId}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
