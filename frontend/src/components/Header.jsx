...
import { Trees, Map, BarChart3, Menu, X } from 'lucide-react'
...
export default function Header() {
  ...
  return (
    <header style={{
      background: 'linear-gradient(135deg, #0a1f0a, #0d1117, #1a0505)',
      ...
      <div style={{
        ...
        <button onClick={() => setOpen(!open)} style={{ display: 'none', background: 'none', border: 'none', color: 'var(--text)', cursor: 'pointer' }}>
